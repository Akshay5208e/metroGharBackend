          ...
          <TableBody>
            {data && data.length>0 && data.map((val,i) => (
              ...
              >
                ...
                <StyledTableCell align="center">{val.propertyApproval===false ? <div>Pending</div> : <div>Approved</div>}</StyledTableCell>
                <StyledTableCell align="center">
                  <StyledButton onClick = {()=>history.push(`/view/${val.id}`)}>View</StyledButton>
                  <StyledButton onClick = {()=>history.push(`/edit/${val.id}`)}>Edit</StyledButton>
                  <StyledButton onClick={()=>deleteProperty(val.id)}>Delete</StyledButton>
                </StyledTableCell>
              </StyledTableRow>
            ))}
          </TableBody>
